<?php include '../assets/includes/header.php'; ?>
					...
					<div class="content-row">
						<div class="panel back-color-white">
							...
							<div class="panel-content-norm">
								...
								<form class="enter-data" method="post" id="setSubject">
									<div>
										<label class="data-name">Subject Code:</label>
										<input type="text" id="subCode" required>
									</div>
									<div>
		...
		<script type="text/javascript">document.getElementById('setSubject').addEventListener('submit', setSubject);</script>
