<?php include '../assets/includes/header.php'; ?>
			...
			<div class="inside-class">
				<ul>
				  ...
				  <li><a class="sactive" href="students.php?id=<?php echo $cid; ?>">Students</a></li>
				</ul>
			</div>
			<!-- END DIRECTORY -->
					...
					<div class="content-row">
						<div class="panel back-color-white">
							<div class="panel-header-norm">
								...
								<a href="classes_addstudent.php?id=<?php echo $cid; ?>"><button class="button-header back-color-green">Add Student</button></a>
							</div>
